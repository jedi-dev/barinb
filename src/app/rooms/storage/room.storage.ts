...
import { RoomDto, RoomEntity } from '../common/room.interface';
...
export class RoomStorage {
  ...
  get(): Observable<RoomEntity[]> {
    return this.localStorage.getItem<RoomDto[]>(ROOMS_STORAGE_KEY).pipe(map((rooms) => (rooms ?? ROOMS_DTO_STUB).map(castRoomEntity)));
  }
